...
def extract_layer_last_numpy(fpath, layerID):
    ...
    def loading_file(x):
        ...
        return [(_[0][layerID][-1], _[1][layerID][-1]) for _ in data]
...
if __name__ == "__main__":
    ...
    for l in [int(sys.argv[1])]:
        ...
        extract_layer_last_numpy("datasets/hh_rlhf_mistral_valid", l)
        extract_layer_last_numpy("datasets/hh_rlhf_mistral_train", l)
        #extract_layer_last_numpy("datasets/hh_rlhf_mistral_train", l)
